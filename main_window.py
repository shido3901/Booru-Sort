...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.tag_list_panel.setStyleSheet("background-color: #112233;"
                                          "border-radius: 10px;" 
                                          "border: 2px solid #1f618d")
        
        self.tag_list_panel_layout = QVBoxLayout()
        ...
        tag_label.setAlignment(Qt.AlignTop)

        self.tag_list_area = QWidget(self.tag_list_panel)
        self.tag_list_area.setMinimumWidth(320)
        self.tag_list_area.setMaximumWidth(320)
        self.tag_list_area.setMinimumHeight(700)
        self.tag_list_area.setMaximumHeight(700)
        self.tag_list_area.setStyleSheet("background-color: black;")
        self.tag_list_area.setParent(self.tag_list_panel)
        self.tag_list_area.move(0,50)
       
        self.tag_list_area.setLayout(QVBoxLayout)
        self.tag_list = TagListManager(self.tag_list_area)
        ...
        self.options_bar.setMinimumHeight(70)
        self.options_bar.setMaximumHeight(70)
        ...
        bottom_bar_layout.addWidget(skip_to_previous, alignment=Qt.AlignLeft)
        bottom_bar_layout.addWidget(self.page_count, alignment=Qt.AlignCenter)
        bottom_bar_layout.addWidget(skip_to_last, alignment=Qt.AlignRight)
