...
class TagProperties:
    def __init__(self, tag_panel_recent_content, tag_name="", file_path_name=""):
    ...
    def create_tag_button(self):
        ...
        shared_state.column_count += 1
        if shared_state.column_count >= 5:
            shared_state.column_count = 0
            shared_state.row_count += 1

        tag_button.bind("<Button-1>", lambda event: show_drag_drop_box(tag_button))
